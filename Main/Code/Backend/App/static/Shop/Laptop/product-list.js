            ...
            <div class="price-list-div">
                <div class="price-item">
                    <a href="${product["Link"]}" class="product-link best-price">
                        <img src= "../../Resources/Mytek.png" alt="Mytek Logo" class = "price-logo-img">
                        <span class="price" id="mytek-price">${product["Price"]}</span>
                    </a>
                </div>
                <div class="price-item">
                    <a href="${product["Link"]}" class="product-link">
                        <img src= "../../Resources/Tunisianet.png" alt="Tunisianet Logo" class = "price-logo-img">
                        <span class="price" id="tunisianet-price">${product["Price"]}</span>
                    </a>
                </div>
                <div class="price-item">
                    <a href="${product["Link"]}" class="product-link">
                        <img src= "../../Resources/ScoopGaming.png" alt="ScoopGaming Logo" class = "price-logo-img">
